...
\vspace{1cm}
{\scriptsize Supervisor: Antti Honkela \\
...
\includegraphics[scale=0.5]{../presentation_pics/FR_data_plain_rev.png}
\end{frame}
...
\includegraphics[scale=0.5]{../presentation_pics/FR_data_color_rev.png}
\end{frame}
