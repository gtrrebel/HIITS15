...
class col_vb2(GPy.core.model.Model, investigable):
	...
	def optimize_autograd(self,method=None, maxiter=500, ftol=1e-6, gtol=1e-6, step_length=1., line_search=False, \
			callback=None, orig_iteration_data=False, print_convergence=False):
		"""
		Optimize the model
	...
	def get_bound(self):
		return self.autograd_bound()(self.get_vb_param())

	def get_gradient(self):
		return self.bound_gradient()(self.get_vb_param())

	def get_hessian(self):
		return self.bound_hessian()(self.get_vb_param())

	def get_theano_gradient(self):
		return self.f2(self.get_vb_param().copy())

	def get_theano_hessian(self):
